    ...
    <div className='br__insidescoop'>
      ...
      <div className='br__insidescoop_carousal'>
        <div className='br__insidescoop_carousal-container'>
          ...
          <h2>Which Ice Cream Suits Your BFF?</h2>
          <p>The day we all enjoyed as kids is finally here…Friendship Day! Think friendship bracelets, colorful bands, and promises to stay friends with everyone you know.</p>
